export function patchRunePreservationCap({ patch }) {
    ...
    patch(AltMagic, 'runePreservationChance').get(function (orig) {
        ...
        let maxPreserve = 80 + this.game.modifiers.getValue("WTM:runePreservationCap", ModifierQuery.EMPTY)
    ...
    patch(PlayerModifierTable, 'getRunePreservationChance').replace(function () {
        ...
        let maxPreserve = 80 + game.modifiers.getValue("WTM:runePreservationCap", ModifierQuery.EMPTY)
