...
`,
    ...
    "WTM_WEAPON_FLAVORTEXT_Polearms": "Keeps distance while thrusting over and over",
    ...
    "WTM_WEAPON_FLAVORTEXT_Crossbows": "Sacrifice speed for absolute accuracy and strength",
